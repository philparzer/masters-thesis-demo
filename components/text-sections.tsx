  ...
  return (
    <div className="px-5">
      <section className="mt-20">
        <h2 className="text-2xl dark:text-white font-semibold mb-4 text-left">
          Examples
        </h2>
      ...
      <section className="mt-20">
        <h2 className="text-2xl dark:text-white font-semibold mb-4">Prompts</h2>
        <p className="text-justify">
          <span className="text-red-500">section coming soon</span>
        </p>
      </section>
      <section className="mt-20">
        <h2 className="text-2xl dark:text-white font-semibold mb-4">The Paper</h2>
        <p className="text-justify">
          <span className="text-red-500">section coming soon</span>
        </p>
      </section>
