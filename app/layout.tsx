  ...
  return (
    ...
    >
      <body className="flex flex-col items-center p-4 pt-24 lg:p-24 bg-slate-50 dark:text-zinc-300 dark:bg-zinc-950">
        ...
        />
        {children}
        <div className="fixed top-4 right-4 bg-white dark:bg-zinc-950 border rounded-md px-4 py-2 text-sm">
          <a className="flex items-center gap-2" href="https://github.com/philparzer/masters-thesis-demo" rel="noopener noreferrer" target="_blank">
            open-source{" "}
            <svg
              width="20"
              viewBox="0 0 98 96"
